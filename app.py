...
# ==================== SERVICES WITH PRICE & DOCUMENTS ====================
SERVICES = [
    {
        "name": "PAN Card", "icon": "🪪", "desc": "New / Correction",
        "price": "₹200",
        "docs": ["आधार कार्ड", "मोबाइल नंबर", "फोटो", "हस्ताक्षर"]
    },
    {
        "name": "Aadhaar Update", "icon": "🆔", "desc": "Address / Mobile",
        "price": "₹200",
        "docs": ["आधार कार्ड", "जिस जानकारी को update करना है उसका valid proof"]
    },
    {
        "name": "Voter ID Card", "icon": "🗳️", "desc": "New / Correction",
        "price": "₹100",
        "docs": ["पहचान प्रमाण", "पता प्रमाण", "फोटो"]
    },
    {
        "name": "Driving Licence", "icon": "🚗", "desc": "Learner / Permanent",
        "price": "₹1,100",
        "docs": ["Aadhaar/पहचान प्रमाण", "पता प्रमाण", "जन्मतिथि प्रमाण", "आवश्यक होने पर मेडिकल प्रमाण"]
    },
    {
        "name": "Ration Card", "icon": "🍚", "desc": "New Ration Card",
        "price": "₹200",
        "docs": ["परिवार के सदस्यों के Aadhaar", "पता प्रमाण", "परिवार के सदस्यों की जानकारी"]
    },
    {
        "name": "Ayushman Card", "icon": "💳", "desc": "PMJAY Golden Card",
        "price": "₹100",
        "docs": ["Aadhaar", "राशन कार्ड/परिवार संबंधी जानकारी, जहाँ लागू हो"]
    },
    {
        "name": "Passport", "icon": "📘", "desc": "New / Renewal",
        "price": "₹2,100",
        "docs": ["Aadhaar/पहचान प्रमाण", "पता प्रमाण", "जन्मतिथि प्रमाण", "आवश्यक supporting documents"]
    },
    {
        "name": "Birth Certificate", "icon": "👶", "desc": "Janm Praman Patra",
        "price": "₹150",
        "docs": ["अस्पताल/जन्म संबंधी रिकॉर्ड", "माता-पिता की जानकारी", "पहचान/पता प्रमाण, जहाँ आवश्यक हो"]
    },
    {
        "name": "Death Certificate", "icon": "📜", "desc": "Mrityu Praman Patra",
        "price": "₹150",
        "docs": ["मृत्यु संबंधी रिकॉर्ड", "मृतक की जानकारी", "पहचान/पता संबंधी दस्तावेज, जहाँ आवश्यक हो"]
    },
    {
        "name": "Income Certificate", "icon": "💰", "desc": "Aay Praman Patra",
        "price": "₹120",
        "docs": ["Aadhaar", "पता प्रमाण", "आय से संबंधित प्रमाण/घोषणा"]
    },
    {
        "name": "Caste Certificate", "icon": "📋", "desc": "Jati Praman Patra",
        "price": "₹120",
        "docs": ["Aadhaar", "निवास/पता प्रमाण", "जाति संबंधी प्रमाण", "अन्य आवश्यक supporting documents"]
    },
    {
        "name": "Domicile Certificate", "icon": "🏠", "desc": "Mool Niwas Praman",
        "price": "₹120",
        "docs": ["Aadhaar", "MP निवास/पता प्रमाण", "अन्य आवश्यक निवास प्रमाण"]
    },
    {
        "name": "e-Shram Card", "icon": "👷", "desc": "Shramik Registration",
        "price": "₹100",
        "docs": ["Aadhaar", "Aadhaar-linked mobile number", "बैंक खाते की जानकारी"]
    },
    {
        "name": "PM-Kisan Registration", "icon": "🌾", "desc": "Kisan Nidhi",
        "price": "₹100",
        "docs": ["Aadhaar", "बैंक खाता", "भूमि संबंधी जानकारी"]
    },
    {
        "name": "Udyam Registration", "icon": "🏭", "desc": "MSME Registration",
        "price": "₹100",
        "docs": ["Aadhaar", "PAN", "व्यवसाय की जानकारी"]
    },
    {
        "name": "GST Registration", "icon": "🧾", "desc": "New GST Number",
        "price": "₹100",
        "docs": ["PAN", "Aadhaar", "व्यवसाय का पता प्रमाण", "बैंक संबंधी जानकारी", "फोटो/अन्य आवश्यक documents"]
    },
    {
        "name": "ITR Filing", "icon": "📊", "desc": "Income Tax Return",
        "price": "₹100",
        "docs": ["PAN", "Aadhaar", "बैंक विवरण", "आय से संबंधित documents", "निवेश/कर से संबंधित documents, जहाँ लागू हो"]
    },
    {
    ...
    {
        "name": "Voter Card Download/Print", "icon": "⬇️", "desc": "e-EPIC Download",
        "price": "₹100",
        "docs": ["Voter ID/EPIC नंबर या आवश्यक voter details"]
    },
]
...
.card:hover {
  ...
  border-color:#FFD700;
  box-shadow: 0 25px 50px rgba(255,215,0,0.35), 0 0 30px rgba(255,215,0,0.2);
}
...
.card .desc {
  font-size:11px; color:#cfd8dc; margin-bottom:10px; font-weight:300;
}
.card .price {
  display:inline-block;
  background: rgba(255,215,0,0.15);
...
.card .price-label { font-size:10px; color:#bbb; font-weight:400; }
...
.card .docs-list.show { display: block; }
@keyframes fadeIn {
  from { opacity:0; transform: translateY(-10px); }
  to   { opacity:1; transform: translateY(0); }
}
.card .docs-list h4 {
  font-size: 12px; color: #FFD700; margin-bottom: 8px;
  font-weight: 700;
}
.card .docs-list ul {
...
@media (max-width:480px) {
  ...
  .container { grid-template-columns: repeat(2, 1fr); gap:12px; padding: 15px 10px 120px; }
  .contact-btn i { width:42px; height:42px; font-size:20px; }
  .card .docs-list li { font-size:10px; }
}
</style>
</head>
<body>
...
<div class="container" id="cardContainer">
  {% for s in services %}
  <div class="card" data-name="{{ s.name|lower }}" style="animation-delay: {{ loop.index0 * 0.05 }}s">
    <span class="icon">{{ s.icon }}</span>
    <h3>{{ s.name }}</h3>
    <div class="desc">{{ s.desc }}</div>
    <div class="price"><span class="price-label">सेवा शुल्क:</span> {{ s.price }}</div>

    <div class="doc-btn" onclick="toggleDocs('docs-{{ loop.index0 }}')">
      <i class="fas fa-file-alt"></i> 📄 Documents देखें
    </div>

    <div class="docs-list" id="docs-{{ loop.index0 }}">
      ...
      <div class="extra-note">आवश्यकता के अनुसार अतिरिक्त दस्तावेज लग सकते हैं।</div>
    </div>

    <div class="apply" onclick="applyService('{{ s.name }}', '{{ s.price }}')">
...
<div class="footer-note">
  ...
  यह एक private service portal है, government website नहीं।
</div>

<div class="contact-bar">
  <a class="contact-btn wa" href="https://wa.me/{{ whatsapp }}?text=नमस्ते%20{{ owner }}%20जी%2C%20मुझे%20सरकारी%20सेवा%20चाहिए" target="_blank">
...
<div class="toast" id="toast">
  <i class="fas fa-check-circle"></i> <span id="toastMsg">WhatsApp पर भेज रहे हैं...</span>
</div>
...
function applyService(serviceName, price) {
  const msg = `नमस्ते, मुझे ${serviceName} के लिए आवेदन करना है।%0A%0AService Price: ${price}%0Aकृपया आगे की प्रक्रिया बताएं।`;
  const url = `https://wa.me/${WHATSAPP}?text=${msg}`;

  const toast = document.getElementById('toast');
  document.getElementById('toastMsg').innerText = serviceName + ' के लिए WhatsApp खुल रहा है...';
